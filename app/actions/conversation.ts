...
export async function getConversations(): Promise<ActionResult<ConversationData[]>> {
  try {
    ...
    return { success: false, error: serializeActionError(error, '获取会话列表失败') }
  }
}
...
export async function createConversation(
  ...
  try {
    ...
    return { success: false, error: serializeActionError(error, '创建会话失败') }
  }
}
...
export async function deleteConversation(
  ...
  try {
    ...
    return { success: false, error: serializeActionError(error, '删除会话失败') }
  }
}
...
export async function updateConversationTitle(
  ...
  try {
    ...
    return { success: false, error: serializeActionError(error, '更新标题失败') }
  }
}
...
export async function toggleConversationPin(
  ...
  try {
    ...
    return { success: false, error: serializeActionError(error, '操作失败') }
  }
}
